...
import com.anniu.ordercall.core.enums.BasicType;
...
public class ConvertUtils {
    ...
    public static Object parse(Class<?> clazz, Object value) {
        try {
            if (clazz.isAssignableFrom(String.class)) {
                ...
                if (StrUtils.isBlank(String.valueOf(value)))
                    return " ";
                else
            ...
            if (Date.class.isAssignableFrom(clazz)) {
                ...
                return DateTimeUtils.parse(valueStr).toDate();
            ...
            // 未找到可转换的类型，返回原值
            return (StrUtils.isBlank(valueStr)) ? null : value;
        }
    }
    ...
    public static Integer[] toIntArray(boolean isIgnoreConvertError, Object... values) {
        ...
        for (int i = 0; i < values.length; i++) {
            ...
            if (null == v && isIgnoreConvertError == false) {
                throw new ToolBoxException(StrUtils.format("Convert [{}] to Integer error!", values[i]));
            }
            ints[i] = v;
        }
        return ints;
    ...
    public static Long[] toLongArray(boolean isIgnoreConvertError, Object... values) {
        ...
        for (int i = 0; i < values.length; i++) {
            ...
            if (null == v && isIgnoreConvertError == false) {
                throw new ToolBoxException(StrUtils.format("Convert [{}] to Long error!", values[i]));
            }
            longs[i] = v;
        }
        return longs;
    ...
    public static Double[] toDoubleArray(boolean isIgnoreConvertError, Object... values) {
        ...
        for (int i = 0; i < values.length; i++) {
            ...
            if (null == v && isIgnoreConvertError == false) {
                throw new ToolBoxException(StrUtils.format("Convert [{}] to Double error!", values[i]));
            }
            doubles[i] = v;
        }
        return doubles;
    ...
    public static <T> Float[] toFloatArray(boolean isIgnoreConvertError, Object... values) {
        ...
        for (int i = 0; i < values.length; i++) {
            ...
            if (null == v && isIgnoreConvertError == false) {
                throw new ToolBoxException(StrUtils.format("Convert [{}] to Float error!", values[i]));
            }
            floats[i] = v;
        }
        return floats;
    ...
    public static Boolean[] toBooleanArray(boolean isIgnoreConvertError, Object... values) {
        ...
        for (int i = 0; i < values.length; i++) {
            ...
            if (null == v && isIgnoreConvertError == false) {
                throw new ToolBoxException(StrUtils.format("Convert [{}] to Boolean error!", values[i]));
            }
            bools[i] = v;
        }
        return bools;
    ...
    public static String convertCharset(String str, String sourceCharset, String destCharset) {
        if (StrUtils.hasBlank(str, sourceCharset, destCharset)) {
            return str;
        }
    ...
    public static <T> T convertMap2Bean(Map<String, Object> map, Class<T> T)
        ...
        for (int i = 0, n = propertyDescriptors.length; i < n; i++) {
            java.beans.PropertyDescriptor descriptor = propertyDescriptors[i];
