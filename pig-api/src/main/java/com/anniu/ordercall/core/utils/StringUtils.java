...
public class StringUtils extends org.apache.commons.lang.StringUtils {
    ...
    public static JSONObject isJSONObject(String args) {
        ...
        try {
            return (JSONObject) JSON.toJSON(args.trim());
        } catch (Exception e) {
            return result;
        }
    }
    ...
    public static String getBASE64(String str, boolean... bf) {
        ...
        String base64 = String.valueOf(Base64.getEncoder().encode(str.getBytes()));
        //去掉 '='
        if (isBlank(bf) && bf[0]) {
    ...
    public static String strToUrlcode(String value) {
        try {
            ...
            com.anniu.ordercall.core.utils.LoggerUtils.error(StringUtils.class, "字符串转换为URLCode失败,value:" + value, e);
            e.printStackTrace();
            return null;
        }
    }
