...
public class LogAop {
    ...
    @Pointcut(value = "@annotation(com.anniu.ordercall.core.annotion.BussinessLog)")
    ...
    private void handle(ProceedingJoinPoint point) throws Exception {
        ...
        LogManager.me().executeLog(LogTaskFactory.bussinessLog(user.getUserId(), user.getName(), bussinessName, className, methodName, msg));
    }
}