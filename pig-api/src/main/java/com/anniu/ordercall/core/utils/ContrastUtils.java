...
import com.anniu.ordercall.core.factory.DictFieldWarpperFactory;
    ...
    public static String contrastObj(String dictClass, String key, Object pojo1, Map<String, String> pojo2) {
        ...
        try {
            ...
            for (Field field : fields) {
                ...
                Method getMethod = pd.getReadMethod();
                Object o1 = getMethod.invoke(pojo1);
                Object o2 = pojo2.get(StrUtils.firstCharToLowerCase(getMethod.getName().substring(3)));
                if (o1 == null || o2 == null) {
                    continue;
                }
                if (o1 instanceof Date) {
    ...
    public static String contrastObjByName(String dictClass, String key, Object pojo1, Map<String, String> pojo2) {
        ...
        try {
            ...
            for (Field field : fields) {
                ...
                try {
                    getMethod = clazz.getDeclaredMethod(prefix + StrUtils.firstCharToUpperCase(field.getName()));
                } catch (NoSuchMethodException e) {
                    System.err.println("this className:" + clazz.getName() + " is not methodName: " + e.getMessage());
                    continue;
                }
                Object o1 = getMethod.invoke(pojo1);
                Object o2 = pojo2.get(StrUtils.firstCharToLowerCase(getMethod.getName().substring(prefixLength)));
                if (o1 == null || o2 == null) {
                    continue;
                }
                if (o1 instanceof Date) {
