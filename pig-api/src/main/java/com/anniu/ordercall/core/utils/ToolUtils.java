...
import com.anniu.ordercall.core.properties.OrderCallProperties;
...
public class ToolUtils {
    ...
    public static String format(String template, Object... values) {
        return StrUtils.format(template, values);
    }
    ...
    public static String format(String template, Map<?, ?> map) {
        return StrUtils.format(template, map);
    }
...
//	}
    ...
    public static String firstLetterToUpper(String val) {
        return StrUtils.firstCharToUpperCase(val);
    }
    ...
    public static String firstLetterToLower(String val) {
        return StrUtils.firstCharToLowerCase(val);
    }
    ...
    public static Boolean getKaptchaOnOff() {
        return SpringContextHolder.getBean(OrderCallProperties.class).getKaptchaOpen();
    }
