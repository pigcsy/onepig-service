package com.anniu.ordercall.core.shiro;

import com.anniu.ordercall.core.shiro.cache.ShiroCache;
import com.anniu.ordercall.core.shiro.filter.LoginFilter;
import com.anniu.ordercall.core.shiro.filter.PermissionFilter;
import com.anniu.ordercall.core.shiro.filter.RoleFilter;
import com.anniu.ordercall.core.shiro.filter.SimpleAuthFilter;
import com.anniu.ordercall.core.shiro.service.impl.ShiroManagerImpl;
...
public class ShiroConfig {
    ...
    @Bean
    @Autowired
    public CacheManager shiroCacheManager(RedisOperations redisOperations) {
    ...
    @Bean
    @Autowired
    public SecurityManager securityManager(CookieRememberMeManager cookieRememberMeManager, CacheManager cacheManager) {
