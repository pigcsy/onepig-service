...
import com.one.pig.core.base.MenuBase;
import com.one.pig.core.enums.MenuEnums;
...
public class MenuUtils {
     ...
     * @return
     */
    public static Set<MenuBase> format(final MenuEnums.LevelEnum beginLevel, Collection<com.one.pig.core.base.MenuBase> sources) {
        Set<com.one.pig.core.base.MenuBase> menuBases = sources.stream().filter(target -> beginLevel.getValue() == target.getLevels())
