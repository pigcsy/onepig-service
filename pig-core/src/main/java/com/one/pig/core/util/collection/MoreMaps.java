package com.one.pig.core.util.collection;
...
import com.one.pig.core.util.collection.type.primitive.IntObjectHashMap;
import com.one.pig.core.util.collection.type.primitive.LongObjectHashMap;
