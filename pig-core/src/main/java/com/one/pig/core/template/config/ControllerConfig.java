...
public class ControllerConfig {
    ...
    public void init() {
        ...
        this.packageName = "com.one.pig.modular." + contextConfig.getModuleName() + ".controller";
        this.controllerPathTemplate = "\\src\\main\\java\\com\\one\\pig\\modular\\" + contextConfig.getModuleName() + "\\controller\\{}Controller.java";
    }
