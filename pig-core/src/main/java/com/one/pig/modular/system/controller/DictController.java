...
import com.one.pig.common.persistence.dao.DictMapper;
...
import com.one.pig.modular.system.service.IDictService;
import com.one.pig.modular.system.warpper.DictWarpper;
...
public class DictController extends BaseController {
     ...
     */
    @BussinessLog(value = "添加字典记录", key = "dictName,dictValues", dict = com.one.pig.common.constant.Dict.DictMap)
     ...
     * 修改字典
     */
    @BussinessLog(value = "修改字典", key = "dictName,dictValues", dict = com.one.pig.common.constant.Dict.DictMap)
     ...
     * 删除字典记录
     */
    @BussinessLog(value = "删除字典记录", key = "dictId", dict = com.one.pig.common.constant.Dict.DeleteDict)
