...
import com.one.pig.core.datascope.DataScope;
...
import com.one.pig.modular.system.factory.UserFactory;
import com.one.pig.modular.system.transfer.UserDto;
import com.one.pig.modular.system.warpper.UserWarpper;
...
public class UserMgrController extends BaseController {
    ...
    @Resource
    private PigProperties pigProperties;
    ...
    public String upload(@RequestPart("file") MultipartFile picture) {
        ...
        try {
            String fileSavePath = pigProperties.getFileUploadPath();
