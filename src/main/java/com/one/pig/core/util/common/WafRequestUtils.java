 ...
 * @Date 2014-5-8
 */
public class WafRequestUtils extends HttpServletRequestWrapper {
    ...
    public WafRequestUtils(HttpServletRequest request, boolean filterXSS, boolean filterSQL) {
        super(request);
    ...
    public WafRequestUtils(HttpServletRequest request) {
