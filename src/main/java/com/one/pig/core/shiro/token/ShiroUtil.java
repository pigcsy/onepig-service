...
public class ShiroUtil {
    ...
    public static List<Integer> getDeptDataScope() {
        ...
        List<Integer> subDeptIds = com.anniu.ordercall.core.factory.ConstantFactory.me().getSubDeptId(deptId);
     ...
     * 获取当前用户的部门数据范围的集合
     */
    public static String getRoleTips() {
        String singleRoleTip = "";
        List<Integer> roleList = ShiroUtil.getUser().getRoleList();
        for (Integer integer : roleList) {
            singleRoleTip = ConstantFactory.me().getSingleRoleTip(integer);
        }
        return singleRoleTip;
    }
