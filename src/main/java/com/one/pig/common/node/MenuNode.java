package com.one.pig.common.node;

import com.one.pig.common.constant.Const;
import com.one.pig.common.constant.state.IsMenu;
...
public class MenuNode implements Comparable {
    ...
    public static List<MenuNode> buildTitle(List<MenuNode> nodes) {
        ...
        PigProperties pigProperties = SpringContextHolder.getBean(PigProperties.class);
        if (!pigProperties.getSwaggerOpen()) {
